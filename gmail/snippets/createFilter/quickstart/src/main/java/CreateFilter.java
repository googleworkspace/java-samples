...
public class CreateFilter {
    // Application name
    private static final String APPLICATION_NAME = "Create Filter Gmail API";
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport)
            throws IOException {
        // Load client secrets.
        InputStream in = CreateFilter.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        Gmail service = new Gmail.Builder(new NetHttpTransport(), JSON_FACTORY, getCredentials(httpTransport))
