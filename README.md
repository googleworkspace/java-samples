# Google Workspace APIs Java Samples [![Build Status](https://travis-ci.org/googleworkspace/java-samples.svg?branch=master)](https://travis-ci.org/googleworkspace/java-samples)
