...
// Unit test class for createSlide snippet
public class TestCreateSlide extends BaseTest{
    ...
    public void testCreateSlide() throws IOException {
        ...
        String pageIdForNew = this.createTestSlide(presentationId);
        BatchUpdatePresentationResponse response = CreateSlide.createSlide(presentationId,pageIdForNew);
