...
// Unit test class for createTextboxWithText snippet
public class TestCreateTextboxWithText extends BaseTest{
    ...
    public void testCreateTextBox() throws IOException {
        ...
        String textBoxId = this.createTestTextBox(presentationId,pageId);
        BatchUpdatePresentationResponse response =
                CreateTextboxWithText.createTextBoxWithText(presentationId, pageId, textBoxId);
