...
/** Class to demonstrate use of create, search and list files in the application data folder. */
public class AppData {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = AppData.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public String fetchAppDataFolder() throws IOException {
        Drive driveService = this.service;
        // [START drive_fetch_appdatafolder]
        File file = driveService.files().get("appDataFolder")
                .setFields("id")
                .execute();
        System.out.println("Folder ID: " + file.getId());
        // [END drive_fetch_appdatafolder]
        return file.getId();
    }
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        AppData appData = new AppData(service);
        // Create file in application data folder
        appData.uploadAppData();
        // Search for files in application data folder
        appData.listAppData();
        // Fetches application data folder's Id.
        appData.fetchAppDataFolder();
    }
